...
if __name__=="__main__":
    ...
    root.configure(background='#FACBEA')
    ...
    heading = Label(root, text="THÔNG TIN ĐĂNG KÝ HỌC PHẦN", bg="#FACBEA", fg="red", font=("Arial", 15, "bold")).place(x=120, y=5)

    mssv = Label(root, text="Mã số sinh viên", bg="#FACBEA").place(x=10, y=30)
 
    # tạo label "Họ tên"
    hoten = Label(root, text="Họ tên", bg="#FACBEA").place(x=10, y=50)
 
    # tạo label "ngày sinh"
    ngaysinh = Label(root, text="Ngày sinh", bg="#FACBEA").place(x=10, y=70)
 
    # tạo label "Email"
    email = Label(root, text="Email", bg="#FACBEA").place(x=10, y=90)
 
    # tạo label "Số điện thoại"
    sdt = Label(root, text="Số điện thoại", bg="#FACBEA").place(x=10, y=110)
 
    # Tạo label "Học kỳ"
    hocky = Label(root, text="Học kỳ", bg="#FACBEA").place(x=10, y=130)
 
    # Tạo label "năm học"
    namhoc = Label(root, text="Năm học", bg="#FACBEA").place(x=10, y=150)
    # tạo label "Chọn môn học"
    chonmonhoc = Label(root, text="Chọn môn học", bg="#FACBEA").place(x=10, y=170)
    ...
    # tạo 4 checkbutton
    cbPython = Checkbutton(root, text="Lập trình Python", variable=var1,bg="#FACBEA").place(x=125, y =170)
    cbJava = Checkbutton(root, text="Lập trình Java", variable=var2,bg="#FACBEA").place(x=290, y =170)
    cbCnpm = Checkbutton(root, text="Công nghệ phần mềm", variable=var3,bg="#FACBEA").place(x=125, y =210)
    cbPTUDW = Checkbutton(root, text="Phát triển ứng dụng web", variable=var4,bg="#FACBEA").place(x=290, y =210)
    # tạo nút đăng ký và nút thoát, nút đăng ký lấy từ hàm submit
    btnDangKy = Button(root, text="Đăng ký", font=("arial", 11, "bold"), bd=1, fg="black", bg="#9EDDFF", command=submit).place(x=150, y=260)
    btnThoat =Button(root, text="Thoát",font=("arial",11, "bold"),bd=1, fg="black",bg="#9EDDFF",command=exit).place(x=330, y=260)
